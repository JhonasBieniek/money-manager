...
- Todos os campos devem conter limitação de caracteres de ponta a ponta para não permitir valores gigantescos no banco de dados.

- Após o usuario definir nome, email e senha ele deverá receber um texto para copiar, como "/start ${token_gerado_para_o_telegram}" e uma explicação do que fazer com esse texto copiado, esse token irá expirar em 15 minutos
