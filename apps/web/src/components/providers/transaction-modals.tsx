...
import { ExpenseModalForm } from "../features/expenses/expense-modal-form";
import { IncomeModalForm } from "../features/incomes/income-modal-form";
...
export function useTransactionModals() {
  ...
  if (!ctx) {
    throw new Error(
      "useTransactionModals must be used within TransactionModalsProvider",
    );
  }
  return ctx;
}
