...
import type { Goal, GoalListResponse } from "@money-manager/types";
  ...
  useEffect(() => {
    async function loadGoals() {
      ...
      try {
        ...
        if (res.ok) {
          const data = (await res.json()) as GoalListResponse;
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(
          errData.message || errData.error || "Erro ao salvar metas",
        );
      }
